const styles: {
    ...
    sectionHeadText:
      "text-slate-900 dark:text-slate-300 font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",
    sectionSubText:
      "text-slate-700 dark:text-slate-300 sm:text-[18px] text-[14px] text-secondary uppercase tracking-wider",
