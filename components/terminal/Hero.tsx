...
import { Prompt, prefersReducedMotion, useTypewriter } from "./util";

const NAME = "Dhruvjyoti Swain";
const TAGLINE = "Python developer · Full-stack · Data engineering";
...
export function Hero() {
  ...
  const name = useTypewriter(NAME, 50, phase >= 1, skip);
  useEffect(() => {
  ...
  const tag = useTypewriter(TAGLINE, 20, phase >= 2, skip);
  useEffect(() => {
